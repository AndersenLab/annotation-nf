...
>[!Note]
>Before running, make sure to check out the [genomes-nf](https://andersenlab.org/dry-guide/latest/pipelines/pipeline-genomes-nf/) pipeline to ensure that the reference genome and annotation databases are set up properly.
...
By default, the reference genome is set by the species parameter. If you don't want to use the default, you could change the project and/or ws_build. As long as the genome is in the proper location on quest (for more, see the [genomes-nf](https://andersenlab.org/dry-guide/latest/pipeline-genomes-nf/) pipeline), this will work. Alternatively, you could provide the path to a reference of your choice.
...
Check out the [CaeNDR](https://andersenlab.org/dry-guide/latest/other/caendr/) page and the [WI protocol](https://katiesevans9.notion.site/Wild-isolate-sequence-analysis-protocol-00e76cc7f55f4bf6ab644dd99c883727) for more information about updating a new data release for CaeNDR.
